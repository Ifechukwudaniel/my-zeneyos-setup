      ...
      luaConfigPost = ''
        ...
        vim.api.nvim_create_autocmd("VimEnter", {
          callback = function()
            ...
            -- Auto-clone windsurf.vim from GitHub if missing
            local plugin_path = vim.fn.stdpath('data') .. '/site/pack/nvf/start/windsurf.vim'
            local git_url = "https://github.com/Exafunction/windsurf.vim"
            if vim.fn.isdirectory(plugin_path) == 0 then
              vim.fn.system({"git", "clone", git_url, plugin_path})
            end
          end,
        })
      '';
